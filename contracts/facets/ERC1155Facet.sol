...
import {CommonConstants} from "../libraries/Utils/Common.sol";
...
/////////////////////////////////////////// ERC1155 //////////////////////////////////////////////
    ...
    */
    function safeTransferFrom(address _from, address _to, uint256 _id, uint256 _value, bytes calldata _data) external override{
        ...
        require(_from == msg.sender || LibERC1155.operatorApproval(_from ) , "Need operator approval for 3rd party transfers.");

        LibERC1155.safeTransferFrom(_from,_to,_id,_value);
    ...
    */
    function safeBatchTransferFrom(address _from, address _to, uint256[] calldata _ids, uint256[] calldata _values, bytes calldata _data) external override {
        ...
        for (uint256 i = 0; i < _ids.length; ++i) {
            ...
            LibERC1155.safeTransferFrom(_from, _to, id, value);
        }
    ...
    function balanceOfBatch(address[] calldata _owners, uint256[] calldata _ids) external override view returns (uint256[] memory) {
        ...
        for (uint256 i = 0; i < _owners.length; ++i) {
            balances_[i] = LibERC1155.balanceOf(_owners[i], _ids[i]);
        }
    ...
    */
    function setApprovalForAll(address _operator, bool _approved) external override {
        ...
        LibERC1155.setOperatorApproval(_operator, _approved);
    ...
    */
    function isApprovedForAll(address _owner, address _operator) external override view returns (bool) {
        ...
        return LibERC1155.operatorApprovalAll(_owner, _operator);
    }
