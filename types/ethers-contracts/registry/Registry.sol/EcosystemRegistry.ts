...
export declare namespace EcosystemRegistry {
...
export interface EcosystemRegistryInterface extends utils.Interface {
  functions: {
...
export interface EcosystemRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: EcosystemRegistryInterface;
  ...
  functions: {
    ...
    getUserEcosystems(
      ...
      [EcosystemRegistry.EcosystemStructOutput[]] & {
        ecosystems_: EcosystemRegistry.EcosystemStructOutput[];
      }
    >;
    ...
    getVersion(
      versionNumber: PromiseOrValue<BytesLike>,
      overrides?: CallOverrides
    ): Promise<[EcosystemRegistry.VersionStructOutput]>;
  ...
  getUserEcosystems(
    ecosystemsOwner: PromiseOrValue<string>,
    overrides?: CallOverrides
  ): Promise<EcosystemRegistry.EcosystemStructOutput[]>;
