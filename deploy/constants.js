const FACETS = [
    'DiamondCutFacet', 'DiamondInit', 'DiamondLoupeFacet', 'ERC1155', 'ERC1155Transfer','ERC1155Receiver','ERC20', 'FreezeGlobal', 'FreezeOwner', 'MemberRegistry',
    'Members', 'Moderator', 'OwnershipFacet', 'EventFactory', 'EventFactoryGetters'
]
const INITALIZE = [
    ['ERC1155', 'mint()'],
