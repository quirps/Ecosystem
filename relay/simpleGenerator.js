...
async function main(owner, merkleRoot, nonce, deadline) {
    ...
    const fullHash = ethers.utils._TypedDataEncoder.hash(msgParams.domain, msgParams.types, msgParams.message);
    ...
    const result = await verifyMessage(fullHash, sigComponents.v, sigComponents.r,sigComponents.s)
}
